...
// Kept close to verbatim; Lymon changes are marked `// LYMON DELTA:` so re-syncing
// with upstream stays a clean diff. Original MIT license/copyright retained above.
